...
public class ResetPasswordService : IResetPasswordService
{
    ...
    public async Task<ResponseMessageDto> CreateResetPasswordTokenAsync(Guid userId)
    {
        if (userId == Guid.Empty)
        {
            ...
            return new ResponseMessageDto("UserId is null or empty", 404, false);
        ...
        try
        {
            ...
            return new ResponseMessageDto("Reset Password Token Created", 201, true);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ResponseMessageDto> UpdatePasswordByTokenAsync(ResetPasswordDto resetPasswordDto)
    {
        ...
        try
        {
            if (resetPasswordDto.Password != resetPasswordDto.ConfirmPassword)
            {
                ...
                return new ResponseMessageDto("Password and ConfirmPassword do not match", 400, false);
            }
            ...
            if (resetPasswordToken == null)
            {
                ...
                return new ResponseMessageDto("Reset Password Token not found", 404, false);
            }
            if (resetPasswordToken.ExpiresAt < DateTime.UtcNow)
            {
                ...
                return new ResponseMessageDto("Reset Password Token has expired", 400, false);
            }
            ...
            if (email == null)
            {
                ...
                return new ResponseMessageDto("Invalid Reset Password Token", 400, false);
            }
            ...
            return new ResponseMessageDto("Password Updated", 200, true);
        }
        catch (Exception ex)
        {
